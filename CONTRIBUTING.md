# Contributing to dcat-ap-linkml

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
dcat-ap-linkml. These guidelines are not strict rules.
...
The dcat-ap-linkml team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the dcat-ap-linkml technical leads
...
[issues]: https://github.com/StroemPhi/dcat-ap-linkml/issues/
[pulls]: https://github.com/StroemPhi/dcat-ap-linkml/pulls/
