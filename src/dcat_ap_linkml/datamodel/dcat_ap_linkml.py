...
from linkml_runtime.linkml_model.types import Decimal, String, Uri
from linkml_runtime.utils.metamodelcore import Decimal, URI
...
class Duration(str):
    ...
    type_name = "duration"
    type_model_uri = LINKMLDCATAP.Duration
...
class HexBinary(str):
    ...
    type_name = "hexBinary"
    type_model_uri = LINKMLDCATAP.HexBinary
...
class NonNegativeInteger(int):
    ...
    type_model_uri = LINKMLDCATAP.NonNegativeInteger
...
class Activity(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Activity
...
class Catalogue(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Catalogue
...
class CatalogueRecord(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.CatalogueRecord
...
class CataloguedResource(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.CataloguedResource
...
class DataService(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.DataService
...
class Dataset(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Dataset
...
class DatasetSeries(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.DatasetSeries
...
class Distribution(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Distribution
...
class SupportiveEntity(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.SupportiveEntity
...
class Agent(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Agent
...
class Attribution(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Attribution
...
class Checksum(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Checksum
...
class ChecksumAlgorithm(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.ChecksumAlgorithm
...
class Concept(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Concept
...
class ConceptScheme(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.ConceptScheme
...
class Document(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Document
...
class Frequency(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Frequency
...
class Geometry(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Geometry
...
class Identifier(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Identifier
...
class Kind(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Kind
...
class LegalResource(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.LegalResource
...
class LicenseDocument(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.LicenseDocument
...
class LinguisticSystem(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.LinguisticSystem
...
class Location(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Location
...
class MediaType(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.MediaType
...
class MediaTypeOrExtent(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.MediaTypeOrExtent
...
class PeriodOfTime(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.PeriodOfTime
...
class Policy(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Policy
...
class ProvenanceStatement(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.ProvenanceStatement
...
class Relationship(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Relationship
...
class Resource(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Resource
...
class RightsStatement(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.RightsStatement
...
class Role(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Role
...
class Standard(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.Standard
...
class TimeInstant(SupportiveEntity):
    ...
    class_model_uri: ClassVar[URIRef] = LINKMLDCATAP.TimeInstant
...
slots.Catalogue_applicable_legislation = Slot(uri=DCATAP.applicableLegislation, name="Catalogue_applicable_legislation", curie=DCATAP.curie('applicableLegislation'),
                   model_uri=LINKMLDCATAP.Catalogue_applicable_legislation, domain=Catalogue, range=Optional[Union[Union[dict, "LegalResource"], List[Union[dict, "LegalResource"]]]])

slots.Catalogue_catalogue = Slot(uri=DCAT.catalog, name="Catalogue_catalogue", curie=DCAT.curie('catalog'),
                   model_uri=LINKMLDCATAP.Catalogue_catalogue, domain=Catalogue, range=Optional[Union[Union[dict, "Catalogue"], List[Union[dict, "Catalogue"]]]])

slots.Catalogue_creator = Slot(uri=DCTERMS.creator, name="Catalogue_creator", curie=DCTERMS.curie('creator'),
                   model_uri=LINKMLDCATAP.Catalogue_creator, domain=Catalogue, range=Optional[Union[dict, "Agent"]])

slots.Catalogue_description = Slot(uri=DCTERMS.description, name="Catalogue_description", curie=DCTERMS.curie('description'),
                   model_uri=LINKMLDCATAP.Catalogue_description, domain=Catalogue, range=Union[str, List[str]])
...
slots.Catalogue_geographical_coverage = Slot(uri=DCTERMS.spatial, name="Catalogue_geographical_coverage", curie=DCTERMS.curie('spatial'),
                   model_uri=LINKMLDCATAP.Catalogue_geographical_coverage, domain=Catalogue, range=Optional[Union[Union[dict, "Location"], List[Union[dict, "Location"]]]])

slots.Catalogue_has_dataset = Slot(uri=DCAT.dataset, name="Catalogue_has_dataset", curie=DCAT.curie('dataset'),
                   model_uri=LINKMLDCATAP.Catalogue_has_dataset, domain=Catalogue, range=Optional[Union[Union[dict, "Dataset"], List[Union[dict, "Dataset"]]]])

slots.Catalogue_has_part = Slot(uri=DCTERMS.hasPart, name="Catalogue_has_part", curie=DCTERMS.curie('hasPart'),
                   model_uri=LINKMLDCATAP.Catalogue_has_part, domain=Catalogue, range=Optional[Union[Union[dict, "Catalogue"], List[Union[dict, "Catalogue"]]]])

slots.Catalogue_homepage = Slot(uri=FOAF.homepage, name="Catalogue_homepage", curie=FOAF.curie('homepage'),
                   model_uri=LINKMLDCATAP.Catalogue_homepage, domain=Catalogue, range=Optional[Union[dict, "Document"]])

slots.Catalogue_language = Slot(uri=DCTERMS.language, name="Catalogue_language", curie=DCTERMS.curie('language'),
                   model_uri=LINKMLDCATAP.Catalogue_language, domain=Catalogue, range=Optional[Union[Union[dict, "LinguisticSystem"], List[Union[dict, "LinguisticSystem"]]]])

slots.Catalogue_licence = Slot(uri=DCTERMS.license, name="Catalogue_licence", curie=DCTERMS.curie('license'),
                   model_uri=LINKMLDCATAP.Catalogue_licence, domain=Catalogue, range=Optional[Union[dict, "LicenseDocument"]])
...
slots.Catalogue_modification_date = Slot(uri=DCTERMS.modified, name="Catalogue_modification_date", curie=DCTERMS.curie('modified'),
                   model_uri=LINKMLDCATAP.Catalogue_modification_date, domain=Catalogue, range=Optional[str])

slots.Catalogue_publisher = Slot(uri=DCTERMS.publisher, name="Catalogue_publisher", curie=DCTERMS.curie('publisher'),
                   model_uri=LINKMLDCATAP.Catalogue_publisher, domain=Catalogue, range=Union[dict, "Agent"])

slots.Catalogue_record = Slot(uri=DCAT.record, name="Catalogue_record", curie=DCAT.curie('record'),
                   model_uri=LINKMLDCATAP.Catalogue_record, domain=Catalogue, range=Optional[Union[Union[dict, "CatalogueRecord"], List[Union[dict, "CatalogueRecord"]]]])

slots.Catalogue_release_date = Slot(uri=DCTERMS.issued, name="Catalogue_release_date", curie=DCTERMS.curie('issued'),
                   model_uri=LINKMLDCATAP.Catalogue_release_date, domain=Catalogue, range=Optional[str])

slots.Catalogue_rights = Slot(uri=DCTERMS.rights, name="Catalogue_rights", curie=DCTERMS.curie('rights'),
                   model_uri=LINKMLDCATAP.Catalogue_rights, domain=Catalogue, range=Optional[Union[dict, "RightsStatement"]])

slots.Catalogue_service = Slot(uri=DCAT.service, name="Catalogue_service", curie=DCAT.curie('service'),
                   model_uri=LINKMLDCATAP.Catalogue_service, domain=Catalogue, range=Optional[Union[Union[dict, "DataService"], List[Union[dict, "DataService"]]]])
...
slots.Catalogue_temporal_coverage = Slot(uri=DCTERMS.temporal, name="Catalogue_temporal_coverage", curie=DCTERMS.curie('temporal'),
                   model_uri=LINKMLDCATAP.Catalogue_temporal_coverage, domain=Catalogue, range=Optional[Union[Union[dict, "PeriodOfTime"], List[Union[dict, "PeriodOfTime"]]]])

slots.Catalogue_themes = Slot(uri=DCAT.themeTaxonomy, name="Catalogue_themes", curie=DCAT.curie('themeTaxonomy'),
                   model_uri=LINKMLDCATAP.Catalogue_themes, domain=Catalogue, range=Optional[Union[Union[dict, "ConceptScheme"], List[Union[dict, "ConceptScheme"]]]])

slots.Catalogue_title = Slot(uri=DCTERMS.title, name="Catalogue_title", curie=DCTERMS.curie('title'),
                   model_uri=LINKMLDCATAP.Catalogue_title, domain=Catalogue, range=Union[str, List[str]])
...
slots.CatalogueRecord_application_profile = Slot(uri=DCTERMS.conformsTo, name="CatalogueRecord_application_profile", curie=DCTERMS.curie('conformsTo'),
                   model_uri=LINKMLDCATAP.CatalogueRecord_application_profile, domain=CatalogueRecord, range=Optional[Union[Union[dict, "Standard"], List[Union[dict, "Standard"]]]])

slots.CatalogueRecord_change_type = Slot(uri=ADMS.status, name="CatalogueRecord_change_type", curie=ADMS.curie('status'),
                   model_uri=LINKMLDCATAP.CatalogueRecord_change_type, domain=CatalogueRecord, range=Optional[Union[dict, "Concept"]])
...
slots.CatalogueRecord_description = Slot(uri=DCTERMS.description, name="CatalogueRecord_description", curie=DCTERMS.curie('description'),
                   model_uri=LINKMLDCATAP.CatalogueRecord_description, domain=CatalogueRecord, range=Optional[Union[str, List[str]]])

slots.CatalogueRecord_language = Slot(uri=DCTERMS.language, name="CatalogueRecord_language", curie=DCTERMS.curie('language'),
                   model_uri=LINKMLDCATAP.CatalogueRecord_language, domain=CatalogueRecord, range=Optional[Union[Union[dict, "LinguisticSystem"], List[Union[dict, "LinguisticSystem"]]]])

slots.CatalogueRecord_listing_date = Slot(uri=DCTERMS.issued, name="CatalogueRecord_listing_date", curie=DCTERMS.curie('issued'),
                   model_uri=LINKMLDCATAP.CatalogueRecord_listing_date, domain=CatalogueRecord, range=Optional[str])
...
slots.CatalogueRecord_modification_date = Slot(uri=DCTERMS.modified, name="CatalogueRecord_modification_date", curie=DCTERMS.curie('modified'),
                   model_uri=LINKMLDCATAP.CatalogueRecord_modification_date, domain=CatalogueRecord, range=str)
...
slots.CatalogueRecord_primary_topic = Slot(uri=FOAF.primaryTopic, name="CatalogueRecord_primary_topic", curie=FOAF.curie('primaryTopic'),
                   model_uri=LINKMLDCATAP.CatalogueRecord_primary_topic, domain=CatalogueRecord, range=Union[dict, "CataloguedResource"])
...
slots.CatalogueRecord_source_metadata = Slot(uri=DCTERMS.source, name="CatalogueRecord_source_metadata", curie=DCTERMS.curie('source'),
                   model_uri=LINKMLDCATAP.CatalogueRecord_source_metadata, domain=CatalogueRecord, range=Optional[Union[dict, "CatalogueRecord"]])

slots.CatalogueRecord_title = Slot(uri=DCTERMS.title, name="CatalogueRecord_title", curie=DCTERMS.curie('title'),
                   model_uri=LINKMLDCATAP.CatalogueRecord_title, domain=CatalogueRecord, range=Optional[Union[str, List[str]]])

slots.Checksum_algorithm = Slot(uri=SPDX.algorithm, name="Checksum_algorithm", curie=SPDX.curie('algorithm'),
                   model_uri=LINKMLDCATAP.Checksum_algorithm, domain=Checksum, range=Union[dict, "ChecksumAlgorithm"])

slots.Checksum_checksum_value = Slot(uri=SPDX.checksumValue, name="Checksum_checksum_value", curie=SPDX.curie('checksumValue'),
                   model_uri=LINKMLDCATAP.Checksum_checksum_value, domain=Checksum, range=str)

slots.Concept_preferred_label = Slot(uri=SKOS.prefLabel, name="Concept_preferred_label", curie=SKOS.curie('prefLabel'),
                   model_uri=LINKMLDCATAP.Concept_preferred_label, domain=Concept, range=Union[str, List[str]])

slots.ConceptScheme_title = Slot(uri=DCTERMS.title, name="ConceptScheme_title", curie=DCTERMS.curie('title'),
                   model_uri=LINKMLDCATAP.ConceptScheme_title, domain=ConceptScheme, range=Union[str, List[str]])
...
slots.DataService_access_rights = Slot(uri=DCTERMS.accessRights, name="DataService_access_rights", curie=DCTERMS.curie('accessRights'),
                   model_uri=LINKMLDCATAP.DataService_access_rights, domain=DataService, range=Optional[Union[dict, "RightsStatement"]])
...
slots.DataService_applicable_legislation = Slot(uri=DCATAP.applicableLegislation, name="DataService_applicable_legislation", curie=DCATAP.curie('applicableLegislation'),
                   model_uri=LINKMLDCATAP.DataService_applicable_legislation, domain=DataService, range=Optional[Union[Union[dict, "LegalResource"], List[Union[dict, "LegalResource"]]]])

slots.DataService_conforms_to = Slot(uri=DCTERMS.conformsTo, name="DataService_conforms_to", curie=DCTERMS.curie('conformsTo'),
                   model_uri=LINKMLDCATAP.DataService_conforms_to, domain=DataService, range=Optional[Union[Union[dict, "Standard"], List[Union[dict, "Standard"]]]])

slots.DataService_contact_point = Slot(uri=DCAT.contactPoint, name="DataService_contact_point", curie=DCAT.curie('contactPoint'),
                   model_uri=LINKMLDCATAP.DataService_contact_point, domain=DataService, range=Optional[Union[Union[dict, "Kind"], List[Union[dict, "Kind"]]]])

slots.DataService_description = Slot(uri=DCTERMS.description, name="DataService_description", curie=DCTERMS.curie('description'),
                   model_uri=LINKMLDCATAP.DataService_description, domain=DataService, range=Optional[Union[str, List[str]]])

slots.DataService_documentation = Slot(uri=FOAF.page, name="DataService_documentation", curie=FOAF.curie('page'),
                   model_uri=LINKMLDCATAP.DataService_documentation, domain=DataService, range=Optional[Union[Union[dict, "Document"], List[Union[dict, "Document"]]]])

slots.DataService_endpoint_URL = Slot(uri=DCAT.endpointURL, name="DataService_endpoint_URL", curie=DCAT.curie('endpointURL'),
                   model_uri=LINKMLDCATAP.DataService_endpoint_URL, domain=DataService, range=Union[Union[dict, "Resource"], List[Union[dict, "Resource"]]])
...
slots.DataService_endpoint_description = Slot(uri=DCAT.endpointDescription, name="DataService_endpoint_description", curie=DCAT.curie('endpointDescription'),
                   model_uri=LINKMLDCATAP.DataService_endpoint_description, domain=DataService, range=Optional[Union[Union[dict, "Resource"], List[Union[dict, "Resource"]]]])

slots.DataService_format = Slot(uri=DCTERMS.format, name="DataService_format", curie=DCTERMS.curie('format'),
                   model_uri=LINKMLDCATAP.DataService_format, domain=DataService, range=Optional[Union[Union[dict, "MediaTypeOrExtent"], List[Union[dict, "MediaTypeOrExtent"]]]])

slots.DataService_keyword = Slot(uri=DCAT.keyword, name="DataService_keyword", curie=DCAT.curie('keyword'),
                   model_uri=LINKMLDCATAP.DataService_keyword, domain=DataService, range=Optional[Union[str, List[str]]])

slots.DataService_landing_page = Slot(uri=DCAT.landingPage, name="DataService_landing_page", curie=DCAT.curie('landingPage'),
                   model_uri=LINKMLDCATAP.DataService_landing_page, domain=DataService, range=Optional[Union[Union[dict, "Document"], List[Union[dict, "Document"]]]])

slots.DataService_licence = Slot(uri=DCTERMS.license, name="DataService_licence", curie=DCTERMS.curie('license'),
                   model_uri=LINKMLDCATAP.DataService_licence, domain=DataService, range=Optional[Union[dict, "LicenseDocument"]])

slots.DataService_publisher = Slot(uri=DCTERMS.publisher, name="DataService_publisher", curie=DCTERMS.curie('publisher'),
                   model_uri=LINKMLDCATAP.DataService_publisher, domain=DataService, range=Optional[Union[dict, "Agent"]])
...
slots.DataService_serves_dataset = Slot(uri=DCAT.servesDataset, name="DataService_serves_dataset", curie=DCAT.curie('servesDataset'),
                   model_uri=LINKMLDCATAP.DataService_serves_dataset, domain=DataService, range=Optional[Union[Union[dict, "Dataset"], List[Union[dict, "Dataset"]]]])

slots.DataService_theme = Slot(uri=DCAT.theme, name="DataService_theme", curie=DCAT.curie('theme'),
                   model_uri=LINKMLDCATAP.DataService_theme, domain=DataService, range=Optional[Union[Union[dict, "Concept"], List[Union[dict, "Concept"]]]])

slots.DataService_title = Slot(uri=DCTERMS.title, name="DataService_title", curie=DCTERMS.curie('title'),
                   model_uri=LINKMLDCATAP.DataService_title, domain=DataService, range=Union[str, List[str]])

slots.Dataset_access_rights = Slot(uri=DCTERMS.accessRights, name="Dataset_access_rights", curie=DCTERMS.curie('accessRights'),
                   model_uri=LINKMLDCATAP.Dataset_access_rights, domain=Dataset, range=Optional[Union[dict, "RightsStatement"]])
...
slots.Dataset_applicable_legislation = Slot(uri=DCATAP.applicableLegislation, name="Dataset_applicable_legislation", curie=DCATAP.curie('applicableLegislation'),
                   model_uri=LINKMLDCATAP.Dataset_applicable_legislation, domain=Dataset, range=Optional[Union[Union[dict, "LegalResource"], List[Union[dict, "LegalResource"]]]])

slots.Dataset_conforms_to = Slot(uri=DCTERMS.conformsTo, name="Dataset_conforms_to", curie=DCTERMS.curie('conformsTo'),
                   model_uri=LINKMLDCATAP.Dataset_conforms_to, domain=Dataset, range=Optional[Union[Union[dict, "Standard"], List[Union[dict, "Standard"]]]])

slots.Dataset_contact_point = Slot(uri=DCAT.contactPoint, name="Dataset_contact_point", curie=DCAT.curie('contactPoint'),
                   model_uri=LINKMLDCATAP.Dataset_contact_point, domain=Dataset, range=Optional[Union[Union[dict, "Kind"], List[Union[dict, "Kind"]]]])

slots.Dataset_creator = Slot(uri=DCTERMS.creator, name="Dataset_creator", curie=DCTERMS.curie('creator'),
                   model_uri=LINKMLDCATAP.Dataset_creator, domain=Dataset, range=Optional[Union[Union[dict, "Agent"], List[Union[dict, "Agent"]]]])
...
slots.Dataset_dataset_distribution = Slot(uri=DCAT.distribution, name="Dataset_dataset_distribution", curie=DCAT.curie('distribution'),
                   model_uri=LINKMLDCATAP.Dataset_dataset_distribution, domain=Dataset, range=Optional[Union[Union[dict, "Distribution"], List[Union[dict, "Distribution"]]]])

slots.Dataset_description = Slot(uri=DCTERMS.description, name="Dataset_description", curie=DCTERMS.curie('description'),
                   model_uri=LINKMLDCATAP.Dataset_description, domain=Dataset, range=Union[str, List[str]])

slots.Dataset_documentation = Slot(uri=FOAF.page, name="Dataset_documentation", curie=FOAF.curie('page'),
                   model_uri=LINKMLDCATAP.Dataset_documentation, domain=Dataset, range=Optional[Union[Union[dict, "Document"], List[Union[dict, "Document"]]]])
...
slots.Dataset_frequency = Slot(uri=DCTERMS.accrualPeriodicity, name="Dataset_frequency", curie=DCTERMS.curie('accrualPeriodicity'),
                   model_uri=LINKMLDCATAP.Dataset_frequency, domain=Dataset, range=Optional[Union[dict, "Frequency"]])
...
slots.Dataset_geographical_coverage = Slot(uri=DCTERMS.spatial, name="Dataset_geographical_coverage", curie=DCTERMS.curie('spatial'),
                   model_uri=LINKMLDCATAP.Dataset_geographical_coverage, domain=Dataset, range=Optional[Union[Union[dict, "Location"], List[Union[dict, "Location"]]]])

slots.Dataset_has_version = Slot(uri=DCAT.hasVersion, name="Dataset_has_version", curie=DCAT.curie('hasVersion'),
                   model_uri=LINKMLDCATAP.Dataset_has_version, domain=Dataset, range=Optional[Union[Union[dict, "Dataset"], List[Union[dict, "Dataset"]]]])

slots.Dataset_identifier = Slot(uri=DCTERMS.identifier, name="Dataset_identifier", curie=DCTERMS.curie('identifier'),
                   model_uri=LINKMLDCATAP.Dataset_identifier, domain=Dataset, range=Optional[Union[Union[str, URI], List[Union[str, URI]]]])

slots.Dataset_in_series = Slot(uri=DCAT.inSeries, name="Dataset_in_series", curie=DCAT.curie('inSeries'),
                   model_uri=LINKMLDCATAP.Dataset_in_series, domain=Dataset, range=Optional[Union[Union[dict, "DatasetSeries"], List[Union[dict, "DatasetSeries"]]]])
...
slots.Dataset_is_referenced_by = Slot(uri=DCTERMS.isReferencedBy, name="Dataset_is_referenced_by", curie=DCTERMS.curie('isReferencedBy'),
                   model_uri=LINKMLDCATAP.Dataset_is_referenced_by, domain=Dataset, range=Optional[Union[Union[dict, "Resource"], List[Union[dict, "Resource"]]]])

slots.Dataset_keyword = Slot(uri=DCAT.keyword, name="Dataset_keyword", curie=DCAT.curie('keyword'),
                   model_uri=LINKMLDCATAP.Dataset_keyword, domain=Dataset, range=Optional[Union[str, List[str]]])

slots.Dataset_landing_page = Slot(uri=DCAT.landingPage, name="Dataset_landing_page", curie=DCAT.curie('landingPage'),
                   model_uri=LINKMLDCATAP.Dataset_landing_page, domain=Dataset, range=Optional[Union[Union[dict, "Document"], List[Union[dict, "Document"]]]])

slots.Dataset_language = Slot(uri=DCTERMS.language, name="Dataset_language", curie=DCTERMS.curie('language'),
                   model_uri=LINKMLDCATAP.Dataset_language, domain=Dataset, range=Optional[Union[Union[dict, "LinguisticSystem"], List[Union[dict, "LinguisticSystem"]]]])

slots.Dataset_modification_date = Slot(uri=DCTERMS.modified, name="Dataset_modification_date", curie=DCTERMS.curie('modified'),
                   model_uri=LINKMLDCATAP.Dataset_modification_date, domain=Dataset, range=Optional[str])

slots.Dataset_other_identifier = Slot(uri=ADMS.identifier, name="Dataset_other_identifier", curie=ADMS.curie('identifier'),
                   model_uri=LINKMLDCATAP.Dataset_other_identifier, domain=Dataset, range=Optional[Union[Union[dict, "Identifier"], List[Union[dict, "Identifier"]]]])

slots.Dataset_provenance = Slot(uri=DCTERMS.provenance, name="Dataset_provenance", curie=DCTERMS.curie('provenance'),
                   model_uri=LINKMLDCATAP.Dataset_provenance, domain=Dataset, range=Optional[Union[Union[dict, "ProvenanceStatement"], List[Union[dict, "ProvenanceStatement"]]]])

slots.Dataset_publisher = Slot(uri=DCTERMS.publisher, name="Dataset_publisher", curie=DCTERMS.curie('publisher'),
                   model_uri=LINKMLDCATAP.Dataset_publisher, domain=Dataset, range=Optional[Union[dict, "Agent"]])
...
slots.Dataset_qualified_attribution = Slot(uri=PROV.qualifiedAttribution, name="Dataset_qualified_attribution", curie=PROV.curie('qualifiedAttribution'),
                   model_uri=LINKMLDCATAP.Dataset_qualified_attribution, domain=Dataset, range=Optional[Union[Union[dict, "Attribution"], List[Union[dict, "Attribution"]]]])
...
slots.Dataset_qualified_relation = Slot(uri=DCAT.qualifiedRelation, name="Dataset_qualified_relation", curie=DCAT.curie('qualifiedRelation'),
                   model_uri=LINKMLDCATAP.Dataset_qualified_relation, domain=Dataset, range=Optional[Union[Union[dict, "Relationship"], List[Union[dict, "Relationship"]]]])

slots.Dataset_related_resource = Slot(uri=DCTERMS.relation, name="Dataset_related_resource", curie=DCTERMS.curie('relation'),
                   model_uri=LINKMLDCATAP.Dataset_related_resource, domain=Dataset, range=Optional[Union[Union[dict, "Resource"], List[Union[dict, "Resource"]]]])

slots.Dataset_release_date = Slot(uri=DCTERMS.issued, name="Dataset_release_date", curie=DCTERMS.curie('issued'),
                   model_uri=LINKMLDCATAP.Dataset_release_date, domain=Dataset, range=Optional[str])

slots.Dataset_sample = Slot(uri=ADMS.sample, name="Dataset_sample", curie=ADMS.curie('sample'),
                   model_uri=LINKMLDCATAP.Dataset_sample, domain=Dataset, range=Optional[Union[Union[dict, "Distribution"], List[Union[dict, "Distribution"]]]])

slots.Dataset_source = Slot(uri=DCTERMS.source, name="Dataset_source", curie=DCTERMS.curie('source'),
                   model_uri=LINKMLDCATAP.Dataset_source, domain=Dataset, range=Optional[Union[Union[dict, "Dataset"], List[Union[dict, "Dataset"]]]])
...
slots.Dataset_spatial_resolution = Slot(uri=DCAT.spatialResolutionInMeters, name="Dataset_spatial_resolution", curie=DCAT.curie('spatialResolutionInMeters'),
                   model_uri=LINKMLDCATAP.Dataset_spatial_resolution, domain=Dataset, range=Optional[Decimal])

slots.Dataset_temporal_coverage = Slot(uri=DCTERMS.temporal, name="Dataset_temporal_coverage", curie=DCTERMS.curie('temporal'),
                   model_uri=LINKMLDCATAP.Dataset_temporal_coverage, domain=Dataset, range=Optional[Union[Union[dict, "PeriodOfTime"], List[Union[dict, "PeriodOfTime"]]]])
...
slots.Dataset_temporal_resolution = Slot(uri=DCAT.temporalResolution, name="Dataset_temporal_resolution", curie=DCAT.curie('temporalResolution'),
                   model_uri=LINKMLDCATAP.Dataset_temporal_resolution, domain=Dataset, range=Optional[str])

slots.Dataset_theme = Slot(uri=DCAT.theme, name="Dataset_theme", curie=DCAT.curie('theme'),
                   model_uri=LINKMLDCATAP.Dataset_theme, domain=Dataset, range=Optional[Union[Union[dict, "Concept"], List[Union[dict, "Concept"]]]])

slots.Dataset_title = Slot(uri=DCTERMS.title, name="Dataset_title", curie=DCTERMS.curie('title'),
                   model_uri=LINKMLDCATAP.Dataset_title, domain=Dataset, range=Union[str, List[str]])

slots.Dataset_type = Slot(uri=DCTERMS.type, name="Dataset_type", curie=DCTERMS.curie('type'),
                   model_uri=LINKMLDCATAP.Dataset_type, domain=Dataset, range=Optional[Union[Union[dict, "Concept"], List[Union[dict, "Concept"]]]])

slots.Dataset_version = Slot(uri=DCAT.version, name="Dataset_version", curie=DCAT.curie('version'),
                   model_uri=LINKMLDCATAP.Dataset_version, domain=Dataset, range=Optional[str])

slots.Dataset_version_notes = Slot(uri=ADMS.versionNotes, name="Dataset_version_notes", curie=ADMS.curie('versionNotes'),
                   model_uri=LINKMLDCATAP.Dataset_version_notes, domain=Dataset, range=Optional[Union[str, List[str]]])
...
slots.Dataset_was_generated_by = Slot(uri=PROV.wasGeneratedBy, name="Dataset_was_generated_by", curie=PROV.curie('wasGeneratedBy'),
                   model_uri=LINKMLDCATAP.Dataset_was_generated_by, domain=Dataset, range=Optional[Union[Union[dict, Activity], List[Union[dict, Activity]]]])
...
slots.DatasetSeries_applicable_legislation = Slot(uri=DCATAP.applicableLegislation, name="DatasetSeries_applicable_legislation", curie=DCATAP.curie('applicableLegislation'),
                   model_uri=LINKMLDCATAP.DatasetSeries_applicable_legislation, domain=DatasetSeries, range=Optional[Union[Union[dict, "LegalResource"], List[Union[dict, "LegalResource"]]]])
...
slots.DatasetSeries_contact_point = Slot(uri=DCAT.contactPoint, name="DatasetSeries_contact_point", curie=DCAT.curie('contactPoint'),
                   model_uri=LINKMLDCATAP.DatasetSeries_contact_point, domain=DatasetSeries, range=Optional[Union[Union[dict, "Kind"], List[Union[dict, "Kind"]]]])
...
slots.DatasetSeries_description = Slot(uri=DCTERMS.description, name="DatasetSeries_description", curie=DCTERMS.curie('description'),
                   model_uri=LINKMLDCATAP.DatasetSeries_description, domain=DatasetSeries, range=Union[str, List[str]])
...
slots.DatasetSeries_frequency = Slot(uri=DCTERMS.accrualPeriodicity, name="DatasetSeries_frequency", curie=DCTERMS.curie('accrualPeriodicity'),
                   model_uri=LINKMLDCATAP.DatasetSeries_frequency, domain=DatasetSeries, range=Optional[Union[dict, "Frequency"]])
...
slots.DatasetSeries_geographical_coverage = Slot(uri=DCTERMS.spatial, name="DatasetSeries_geographical_coverage", curie=DCTERMS.curie('spatial'),
                   model_uri=LINKMLDCATAP.DatasetSeries_geographical_coverage, domain=DatasetSeries, range=Optional[Union[Union[dict, "Location"], List[Union[dict, "Location"]]]])
...
slots.DatasetSeries_modification_date = Slot(uri=DCTERMS.modified, name="DatasetSeries_modification_date", curie=DCTERMS.curie('modified'),
                   model_uri=LINKMLDCATAP.DatasetSeries_modification_date, domain=DatasetSeries, range=Optional[str])

slots.DatasetSeries_publisher = Slot(uri=DCTERMS.publisher, name="DatasetSeries_publisher", curie=DCTERMS.curie('publisher'),
                   model_uri=LINKMLDCATAP.DatasetSeries_publisher, domain=DatasetSeries, range=Optional[Union[dict, "Agent"]])

slots.DatasetSeries_release_date = Slot(uri=DCTERMS.issued, name="DatasetSeries_release_date", curie=DCTERMS.curie('issued'),
                   model_uri=LINKMLDCATAP.DatasetSeries_release_date, domain=DatasetSeries, range=Optional[str])
...
slots.DatasetSeries_temporal_coverage = Slot(uri=DCTERMS.temporal, name="DatasetSeries_temporal_coverage", curie=DCTERMS.curie('temporal'),
                   model_uri=LINKMLDCATAP.DatasetSeries_temporal_coverage, domain=DatasetSeries, range=Optional[Union[Union[dict, "PeriodOfTime"], List[Union[dict, "PeriodOfTime"]]]])

slots.DatasetSeries_title = Slot(uri=DCTERMS.title, name="DatasetSeries_title", curie=DCTERMS.curie('title'),
                   model_uri=LINKMLDCATAP.DatasetSeries_title, domain=DatasetSeries, range=Union[str, List[str]])

slots.Distribution_access_URL = Slot(uri=DCAT.accessURL, name="Distribution_access_URL", curie=DCAT.curie('accessURL'),
                   model_uri=LINKMLDCATAP.Distribution_access_URL, domain=Distribution, range=Union[Union[dict, "Resource"], List[Union[dict, "Resource"]]])
...
slots.Distribution_access_service = Slot(uri=DCAT.accessService, name="Distribution_access_service", curie=DCAT.curie('accessService'),
                   model_uri=LINKMLDCATAP.Distribution_access_service, domain=Distribution, range=Optional[Union[Union[dict, DataService], List[Union[dict, DataService]]]])
...
slots.Distribution_applicable_legislation = Slot(uri=DCATAP.applicableLegislation, name="Distribution_applicable_legislation", curie=DCATAP.curie('applicableLegislation'),
                   model_uri=LINKMLDCATAP.Distribution_applicable_legislation, domain=Distribution, range=Optional[Union[Union[dict, "LegalResource"], List[Union[dict, "LegalResource"]]]])
...
slots.Distribution_availability = Slot(uri=DCATAP.availability, name="Distribution_availability", curie=DCATAP.curie('availability'),
                   model_uri=LINKMLDCATAP.Distribution_availability, domain=Distribution, range=Optional[Union[dict, "Concept"]])

slots.Distribution_byte_size = Slot(uri=DCAT.byteSize, name="Distribution_byte_size", curie=DCAT.curie('byteSize'),
                   model_uri=LINKMLDCATAP.Distribution_byte_size, domain=Distribution, range=Optional[int])

slots.Distribution_checksum = Slot(uri=SPDX.checksum, name="Distribution_checksum", curie=SPDX.curie('checksum'),
                   model_uri=LINKMLDCATAP.Distribution_checksum, domain=Distribution, range=Optional[Union[dict, "Checksum"]])
...
slots.Distribution_compression_format = Slot(uri=DCAT.compressFormat, name="Distribution_compression_format", curie=DCAT.curie('compressFormat'),
                   model_uri=LINKMLDCATAP.Distribution_compression_format, domain=Distribution, range=Optional[Union[dict, "MediaType"]])
...
slots.Distribution_description = Slot(uri=DCTERMS.description, name="Distribution_description", curie=DCTERMS.curie('description'),
                   model_uri=LINKMLDCATAP.Distribution_description, domain=Distribution, range=Optional[Union[str, List[str]]])

slots.Distribution_documentation = Slot(uri=FOAF.page, name="Distribution_documentation", curie=FOAF.curie('page'),
                   model_uri=LINKMLDCATAP.Distribution_documentation, domain=Distribution, range=Optional[Union[Union[dict, "Document"], List[Union[dict, "Document"]]]])

slots.Distribution_download_URL = Slot(uri=DCAT.downloadURL, name="Distribution_download_URL", curie=DCAT.curie('downloadURL'),
                   model_uri=LINKMLDCATAP.Distribution_download_URL, domain=Distribution, range=Optional[Union[Union[dict, "Resource"], List[Union[dict, "Resource"]]]])

slots.Distribution_format = Slot(uri=DCTERMS.format, name="Distribution_format", curie=DCTERMS.curie('format'),
                   model_uri=LINKMLDCATAP.Distribution_format, domain=Distribution, range=Optional[Union[dict, "MediaTypeOrExtent"]])

slots.Distribution_has_policy = Slot(uri=ODRL.hasPolicy, name="Distribution_has_policy", curie=ODRL.curie('hasPolicy'),
                   model_uri=LINKMLDCATAP.Distribution_has_policy, domain=Distribution, range=Optional[Union[dict, "Policy"]])

slots.Distribution_language = Slot(uri=DCTERMS.language, name="Distribution_language", curie=DCTERMS.curie('language'),
                   model_uri=LINKMLDCATAP.Distribution_language, domain=Distribution, range=Optional[Union[Union[dict, "LinguisticSystem"], List[Union[dict, "LinguisticSystem"]]]])

slots.Distribution_licence = Slot(uri=DCTERMS.license, name="Distribution_licence", curie=DCTERMS.curie('license'),
                   model_uri=LINKMLDCATAP.Distribution_licence, domain=Distribution, range=Optional[Union[dict, "LicenseDocument"]])
...
slots.Distribution_linked_schemas = Slot(uri=DCTERMS.conformsTo, name="Distribution_linked_schemas", curie=DCTERMS.curie('conformsTo'),
                   model_uri=LINKMLDCATAP.Distribution_linked_schemas, domain=Distribution, range=Optional[Union[Union[dict, "Standard"], List[Union[dict, "Standard"]]]])

slots.Distribution_media_type = Slot(uri=DCAT.mediaType, name="Distribution_media_type", curie=DCAT.curie('mediaType'),
                   model_uri=LINKMLDCATAP.Distribution_media_type, domain=Distribution, range=Optional[Union[dict, "MediaType"]])
...
slots.Distribution_modification_date = Slot(uri=DCTERMS.modified, name="Distribution_modification_date", curie=DCTERMS.curie('modified'),
                   model_uri=LINKMLDCATAP.Distribution_modification_date, domain=Distribution, range=Optional[str])
...
slots.Distribution_packaging_format = Slot(uri=DCAT.packageFormat, name="Distribution_packaging_format", curie=DCAT.curie('packageFormat'),
                   model_uri=LINKMLDCATAP.Distribution_packaging_format, domain=Distribution, range=Optional[Union[dict, "MediaType"]])

slots.Distribution_release_date = Slot(uri=DCTERMS.issued, name="Distribution_release_date", curie=DCTERMS.curie('issued'),
                   model_uri=LINKMLDCATAP.Distribution_release_date, domain=Distribution, range=Optional[str])

slots.Distribution_rights = Slot(uri=DCTERMS.rights, name="Distribution_rights", curie=DCTERMS.curie('rights'),
                   model_uri=LINKMLDCATAP.Distribution_rights, domain=Distribution, range=Optional[Union[dict, "RightsStatement"]])
...
slots.Distribution_spatial_resolution = Slot(uri=DCAT.spatialResolutionInMeters, name="Distribution_spatial_resolution", curie=DCAT.curie('spatialResolutionInMeters'),
                   model_uri=LINKMLDCATAP.Distribution_spatial_resolution, domain=Distribution, range=Optional[Decimal])

slots.Distribution_status = Slot(uri=ADMS.status, name="Distribution_status", curie=ADMS.curie('status'),
                   model_uri=LINKMLDCATAP.Distribution_status, domain=Distribution, range=Optional[Union[dict, "Concept"]])
...
slots.Distribution_temporal_resolution = Slot(uri=DCAT.temporalResolution, name="Distribution_temporal_resolution", curie=DCAT.curie('temporalResolution'),
                   model_uri=LINKMLDCATAP.Distribution_temporal_resolution, domain=Distribution, range=Optional[str])

slots.Distribution_title = Slot(uri=DCTERMS.title, name="Distribution_title", curie=DCTERMS.curie('title'),
                   model_uri=LINKMLDCATAP.Distribution_title, domain=Distribution, range=Optional[Union[str, List[str]]])

slots.Identifier_notation = Slot(uri=SKOS.notation, name="Identifier_notation", curie=SKOS.curie('notation'),
                   model_uri=LINKMLDCATAP.Identifier_notation, domain=Identifier, range=Union[str, URI])

slots.LicenseDocument_type = Slot(uri=DCTERMS.type, name="LicenseDocument_type", curie=DCTERMS.curie('type'),
                   model_uri=LINKMLDCATAP.LicenseDocument_type, domain=LicenseDocument, range=Optional[Union[Union[dict, Concept], List[Union[dict, Concept]]]])

slots.Location_bbox = Slot(uri=DCAT.bbox, name="Location_bbox", curie=DCAT.curie('bbox'),
                   model_uri=LINKMLDCATAP.Location_bbox, domain=Location, range=Optional[str])

slots.Location_centroid = Slot(uri=DCAT.centroid, name="Location_centroid", curie=DCAT.curie('centroid'),
                   model_uri=LINKMLDCATAP.Location_centroid, domain=Location, range=Optional[str])

slots.Location_geometry = Slot(uri=LOCN.geometry, name="Location_geometry", curie=LOCN.curie('geometry'),
                   model_uri=LINKMLDCATAP.Location_geometry, domain=Location, range=Optional[Union[dict, Geometry]])

slots.PeriodOfTime_beginning = Slot(uri=TIME.hasBeginning, name="PeriodOfTime_beginning", curie=TIME.curie('hasBeginning'),
                   model_uri=LINKMLDCATAP.PeriodOfTime_beginning, domain=PeriodOfTime, range=Optional[Union[dict, "TimeInstant"]])

slots.PeriodOfTime_end = Slot(uri=TIME.hasEnd, name="PeriodOfTime_end", curie=TIME.curie('hasEnd'),
                   model_uri=LINKMLDCATAP.PeriodOfTime_end, domain=PeriodOfTime, range=Optional[Union[dict, "TimeInstant"]])

slots.PeriodOfTime_end_date = Slot(uri=DCAT.endDate, name="PeriodOfTime_end_date", curie=DCAT.curie('endDate'),
                   model_uri=LINKMLDCATAP.PeriodOfTime_end_date, domain=PeriodOfTime, range=Optional[str])

slots.PeriodOfTime_start_date = Slot(uri=DCAT.startDate, name="PeriodOfTime_start_date", curie=DCAT.curie('startDate'),
                   model_uri=LINKMLDCATAP.PeriodOfTime_start_date, domain=PeriodOfTime, range=Optional[str])

slots.Relationship_had_role = Slot(uri=DCAT.hadRole, name="Relationship_had_role", curie=DCAT.curie('hadRole'),
                   model_uri=LINKMLDCATAP.Relationship_had_role, domain=Relationship, range=Union[Union[dict, "Role"], List[Union[dict, "Role"]]])

slots.Relationship_relation = Slot(uri=DCTERMS.relation, name="Relationship_relation", curie=DCTERMS.curie('relation'),
                   model_uri=LINKMLDCATAP.Relationship_relation, domain=Relationship, range=Union[Union[dict, "Resource"], List[Union[dict, "Resource"]]])